		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Sumo Managment",
									"targetURL": "#comsumoleaveworkflowuimodule-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsumoleaveworkflowuimodule-display": {
								"semanticObject": "comsumoleaveworkflowuimodule",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sumoleave.workflowuimodule",
									"url": sap.ui.require.toUrl("com/sumoleave/workflowuimodule")
								}
							}
						}
					}
